...
An [introductory tutorial for bayesian network meta-analyses](https://benjburgess.github.io/i/bayesian_nma) where `R` code is provided. The tutorial provides a step-by-step workflow for how to conduct a bayesian network meta-analysis which replicates a published analysis previously conducted in WINBUGS.
