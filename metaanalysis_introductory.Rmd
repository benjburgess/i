...
As I've detailed in the [introduction to meta-analyses](https://benjburgess.github.io/svm),
...
The next thing we need to do is load in the data we are going to be analysing. I will make this available via [github](github.com/benjburgess) for anyone wanting to replicate this analysis.
...
If we wanted to, we could stop our analysis at this point. The model we have build is appropriate for our dataset. However, we also have the option of considering various different fixed effects. In other words, determining whether the effect of pesticide on zooplankton survival varies across another variable. We further analysis we could conduct is considering whether the effect of pesticide varies with its intensity. Let's have a look again at the Intensity column of our dataset.
