...
##if devtools is not installed on your machine then it can be installed via the following code:
#install.packages("devtools")
#library(devtools)
#install_github("benjburgess/multiplestressR")

##Note that the above hashtags will need to be removed in order for the code to run
